...
def create_html_string():
    """reads the template file and replaces the placeholder text with the generated html code"""
...
def main():
    """Reads a template html file, adds html derived form json data and writes the result to new file."""
